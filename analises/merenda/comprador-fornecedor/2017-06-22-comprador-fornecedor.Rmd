...
Antes de iniciarmos a analisar os gastos públicos, é importante entender que esses gastos geralmente ocorrem via licitações. Este [outro post](https://analytics-ufcg.github.io/licitacoes-pb//2017/05/execucaoorcamentaria.html) preparado por nós explica com mais detalhes o papel das licitações no processo de despesa pública dos municípios
...
A partir do gráfico acima podemos observar que as modalidades mais utilizadas nas licitações de merenda atualmente são a chamada pública e o pregão presencial. Esta última foi a modalidade mais utilizada para esse tipo de licitação até ser superada pelo pregão presencial, em 2013, e é uma das modalidades mais suscetíveis à fraude, visto que é possível ocorrer, dentre outras coisas, acordo prévio entre os participantes e a coação de compertidores para fazê-los desistir. 
