...
Podemos perceber que houve um "salto" no número de licitações entre 2012 e 2013, o que indica que os municípios passaram fazer mais licitações envolvendo merenda, esse salto acontece também nos dados gerais de licitação e já foi analisado neste mesmo relatório. E exceto por 2012, a quantidade de licitações varia pouco.
