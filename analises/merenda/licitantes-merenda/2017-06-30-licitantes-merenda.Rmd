...
#### Grupo 1 - Em dieta
Esses grupo de fornecedores costuma ganhar poucas licitações. Eles também são os fornecedores que ganham as licitações de valor mais modesto dentre todos os outros.

#### Grupo 2 - 
Assim como fornecedores do grupo 1, esses fornecedores costumam ganhar licitações em poucos municípios. A principal diferença deles para os fornecedores do grupo 2 é que eles geralmente ganham licitações mais caras.

#### Grupo 3 - Comilões
Esses fornecedores costumam ganhar um número considerável de licitações em diversos municípios e apresentam a maior diversidade no valor da mediana dos empenhos. 

#### Grupo 4 - Papa-tudo
Assim como os fornecedores do grupo anterior, os fornecedores desse grupo ganham muitas licitações. A diferença entre esses dois grupos está no fato que esses fornecedores costumam ganhar licitações mais caras e em muito mais municípios.

#### Grupo 5 - Olho-grande
De maneira similar aos fornecedores do grupo 1, esses fornecedores costumam ganhar poucas licitações. O que os diferencia é que os fornecedores desse grupo em geral apresentam empenhos mais caros. Além disso, os valores empenhados para esses fornecedores costumam ser bem maiores que os valores pagos ao final do processo de execução.
