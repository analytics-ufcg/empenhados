...
municipios <- municipios %>%
  left_join(ideb_4ano %>% select('Município', '2015')
              , c('de_Municipio' = 'Município')) %>%
  mutate(IDEB_4ano_2015 = as.numeric(`2015`)) %>%
  mutate('2015' = NULL) %>%
  left_join(ideb_9ano %>% select('Município', '2015')
              , c('de_Municipio' = 'Município')) %>%
  mutate(IDEB_9ano_2015 = as.numeric(`2015`)) %>%
  mutate('2015' = NULL) %>%
  mutate(IDEB_medio_2015 = (IDEB_4ano_2015 + IDEB_9ano_2015) / 2) %>%
...
ggplot(data = filter(municipios, IDEB_4ano_2015 != 0), aes(y = gasto_por_aluno, x = IDEB_4ano_2015)) +
  geom_point()

ggplot(data = filter(municipios, IDEB_9ano_2015 != 0), aes(y = gasto_por_aluno, x = IDEB_9ano_2015)) +
  geom_point()

ggplot(data = filter(municipios, IDEB_medio_2015 != 0), aes(y = gasto_por_aluno, x = IDEB_medio_2015)) +
  geom_point()


cor(filter(municipios, IDEB_4ano_2015 != 0)$gasto_por_aluno, filter(municipios, IDEB_4ano_2015 != 0)$IDEB_4ano_2015)
cor(filter(municipios, IDEB_9ano_2015 != 0)$gasto_por_aluno, filter(municipios, IDEB_9ano_2015 != 0)$IDEB_9ano_2015)
