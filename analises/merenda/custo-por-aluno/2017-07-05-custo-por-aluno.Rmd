...
Quanto será que São José do Brejo do Cruz gastou com cada em outros anos?
...
```{r}
plot_ly(data = gasto_sao_jose, x = ~as.factor(dt_Ano)) %>%
  add_trace(y = ~custo_aluno, type = 'scatter', name = 'Total', mode = 'lines+markers', color='orange') %>%
