...
## 8 - Geralmente, quantas propostas são recebidas para licitações de merenda? {#perg-7}
...
## 9 - Que tipo de licitação é mais comum na compra de merenda? {#perg-8}
...
## 11 - A popularidade de alguma modalidade de licitação mudou ao longo dos anos? {#perg-10}
Dando prosseguimento à análise, foi verificado quais modalidades de licitação foram mais utilizadas para a obtenção de merenda entre os anos 2010 e 2015. Os resultados podem ser observados na figura lorem.  
...
## 12 - Em geral, as licitaçoes mais caras estao concentradas em alguma época do ano? {#perg-11}
...
## 13 - O valor da licitação está relacionado com o total de propostas recebidas? {#perg-12}
...
## 14 - Qual a relação entre o total de licitações de merenda e o número de propostas por modalidade?
