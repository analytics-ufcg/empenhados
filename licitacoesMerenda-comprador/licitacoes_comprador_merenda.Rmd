...
## Qual a relação entre o total de licitações de merenda e o número de propostas por modalidade?
...
data_temp = data.frame(de_Municipio = c('Mato Grosso', 'Nova Floresta', 'Mamanguape', 'Sao Vicente do Serido'),
                       total = c(0, 0, 0, 9), valor_medio_lic = c(0, 0, 0, mean(subset(merenda_paraiba, de_Municipio == "São Vicente do Seridó")$vl_Licitacao)))
...
##  Qual a distribuição do valor médio de licitações de merenda escolar entre todos os municípios da Paraíba? 
