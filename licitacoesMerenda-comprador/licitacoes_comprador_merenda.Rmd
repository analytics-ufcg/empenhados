...
# Imputação de dados
# paraiba_sumarizado[221] = c('Mato Grosso', NA)
# paraiba_sumarizado[222] = c('Nova Floresta', NA)
# paraiba_sumarizado[223] = c('Mamanguape', NA]
# 
# paraiba_sumarizado$total = cut(paraiba_sumarizado$total, breaks = seq(0, 70, 10))
```

```{r}
mapa_paraiba@data$Y <- paraiba_sumarizado$total
mapa_paraiba@data$X <- paraiba_sumarizado$Nome_Munic
