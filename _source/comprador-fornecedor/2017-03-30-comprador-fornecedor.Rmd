...
licitacoes_merenda %>%
  ...
  scale_x_continuous(breaks = seq(2011, 2015, 1)) +
  geom_text(aes(2010.5, media_total, label = 'Média geral', vjust = -1, hjust = -0.1), size = 4) +
  xlab("Ano") +
  ylab("Valor médio") +
...
licitacoes_merenda %>%
  ...
  geom_hline(yintercept = mediana_total, 
             color = 'blue', linetype = 'dashed') +
  scale_x_continuous(breaks = seq(2011, 2015, 1)) +
  geom_text(aes(2010.5, mediana_total, label = 'Mediana geral', vjust = -1, hjust = -0.1), size = 4) +
  xlab("Ano") +
  ylab("Valor mediano") +
