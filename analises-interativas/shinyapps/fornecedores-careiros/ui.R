    ...
    fluidRow(
      ...
      fixedRow(width = 2,
               ...
               box(title = "O que é Atipicidade?",
                    width = 2, status = "primary", solidHeader = TRUE, tags$div(style="text-align:justify", tags$p("A", strong('atipicidade'), "de um fornecedor para um NCM é calculada considerando a distância normalizada entre o preço 
