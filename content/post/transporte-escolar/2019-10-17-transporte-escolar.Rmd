...
empenhos %>%
  ...
  labs(
    title = "Municípios que empenharam mais dinheiro \nem 2016",
    x = "Municípios",
...
maximo.gasto <- gasto_municipio_aluno %>% pull(gasto_por_aluno) %>% max() %>% round(0)
minimo.gasto <- gasto_municipio_aluno %>% pull(gasto_por_aluno) %>% min() %>% round(0)
