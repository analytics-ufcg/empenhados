...
empenhos_nao_pagos %>%
  ...
  labs(
    title = "Total empenhado pelos municípios que não \nrealizaram pagamentos",
    x = "Municípios",
...
Os municípios de Monteiro e Água Branca realizaram empenhos com valores altos, mas não há, nos dados, nenhum pagamento desses municípios. 
