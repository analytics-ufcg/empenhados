...
thumbnailImage: "/images/posts/realinhamento-de-precos/thumb.jpg"
...
A seguir serão estudados os valores descritos em cada fase do processo de execução orçamentária, aos quais foi aplicada uma escala logarítma na base 10 para facilitar a visualização dos dados. Nos gráficos de dispersão, cada ponto representa uma das 1031 licitações estudadas.
