...
thumbnailImage: "/images/posts/descricao-fornecedores-merenda/thumb.png"
...
kable(vencedores3[order(vencedores3$n),], caption = "Fornecedores que fecharam mais de 20 contratos",
      col.names = c("CPF/CNPJ", "Nome", "Número de contratos"), row.names = FALSE)
```
